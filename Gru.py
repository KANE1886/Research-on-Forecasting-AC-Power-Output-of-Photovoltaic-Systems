...
pd.DataFrame({'epoch': history_metrics['epoch'], 'val_MAE': history_metrics['val_MAE']}).to_excel("val_MAE.xlsx", index=False)
pd.DataFrame({'epoch': history_metrics['epoch'], 'val_MAPE': history_metrics['val_MAPE']}).to_excel("val_MAPE.xlsx", index=False)
pd.DataFrame({'epoch': history_metrics['epoch'], 'val_RMSE': history_metrics['val_RMSE']}).to_excel("val_RMSE.xlsx", index=False)
pd.DataFrame({'epoch': history_metrics['epoch'], 'val_R2': history_metrics['val_R2']}).to_excel("val_R2.xlsx", index=False)
